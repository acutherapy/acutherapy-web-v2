...
export default function AcupunctureVsChiropracticBackPainPage() {
  return (
    <>
      <Helmet>
        ...
        <script type="application/ld+json">
          {`
          {
            ...
            "@type": "MedicalWebPage",
            "name": "Acupuncture Vs Chiropractic Back Pain Treatment in Honolulu | AcuTherapy Clinics",
            "headline": "Acupuncture Vs Chiropractic Back Pain",
            "description": "Tired of Acupuncture Vs Chiropractic Back Pain? Dr. David Cai provides effective, non-surgical relief using advanced acupuncture and traditional Chinese medicine in Honolulu.",
