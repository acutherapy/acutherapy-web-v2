...
export default function PlantarFasciitisAcupunctureHonoluluPage() {
  return (
    <>
      <Helmet>
        <title>Plantar Fasciitis Acupuncture Honolulu Treatment in Honolulu | AcuTherapy Clinics</title>
        <meta name="description" content="Tired of Plantar Fasciitis Acupuncture Honolulu? Dr. David Cai provides effective, non-surgical relief using advanced acupuncture and traditional Chinese medicine in Honolulu." />
        <script type="application/ld+json">
          {`
          {
            "@context": "https://schema.org",
            "@type": "MedicalWebPage",
            "name": "Plantar Fasciitis Acupuncture Honolulu Treatment in Honolulu | AcuTherapy Clinics",
            "headline": "Plantar Fasciitis Acupuncture Honolulu",
            "description": "Tired of Plantar Fasciitis Acupuncture Honolulu? Dr. David Cai provides effective, non-surgical relief using advanced acupuncture and traditional Chinese medicine in Honolulu.",
            "url": "https://acutherapy.com/plantar-fasciitis-acupuncture-honolulu",
            "provider": {
      ...
      <div className="relative rounded-3xl overflow-hidden shadow-2xl ring-4 ring-white/50 group mb-12 w-full max-w-3xl mx-auto">
        <img src="/images/abdominal-acupuncture.jpg" alt="Plantar Fasciitis Acupuncture Honolulu" className="w-full h-[450px] object-cover transition-transform duration-700 group-hover:scale-105" onError={(e) => { e.currentTarget.src = 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=800'; }} />
