  ...
  return (
    <>
      <Helmet>
        ...
        <title>Acupuncture Honolulu | Pain & Injury Treatment | AcuTherapy Clinics</title>
        <meta name="description" content="Top-rated Acupuncture Honolulu services in Honolulu. Dr. David Cai specializes in pain management, auto accident recovery, and chronic conditions." />
        <script type="application/ld+json">
          {`
          {
            "@context": "https://schema.org",
            "@type": "MedicalWebPage",
            "name": "Acupuncture Honolulu | Pain & Injury Treatment | AcuTherapy Clinics",
            "headline": "Acupuncture Honolulu",
            "description": "Top-rated Acupuncture Honolulu services in Honolulu. Dr. David Cai specializes in pain management, auto accident recovery, and chronic conditions.",
            "url": "https://acutherapy.com/acupuncture-honolulu",
            "provider": {
      ...
      <section className="bg-blue-900 text-white relative py-20 lg:py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 tracking-tight">Acupuncture Honolulu</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-12 gap-12">
          ...
          <article className="md:col-span-8">
              ...
              <p className="text-xl text-slate-800 leading-relaxed font-medium mb-8">
                If you are suffering from chronic pain, an injury, or stress-related health problems, <strong>Acupuncture Honolulu</strong> provides a natural, effective pathway to healing. At AcuTherapy Clinics in Honolulu, Dr. David Cai utilizes over 30 years of clinical expertise in Traditional Chinese Medicine (TCM).
              </p>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <figure className="relative rounded-3xl overflow-hidden shadow-2xl ring-4 ring-white/50 group">
          ...
          <figcaption className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-blue-900/90 to-transparent p-6 pt-12 text-white font-medium">Dr. Cai Preparing Acupuncture Protocol</figcaption>
        </figure>
        <figure className="relative rounded-3xl overflow-hidden shadow-2xl ring-4 ring-white/50 group mt-8 md:mt-0">
          ...
          <figcaption className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-blue-900/90 to-transparent p-6 pt-12 text-white font-medium">Precision Needling & Peripheral Blood Flow</figcaption>
        </figure>
      </div>
              <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6 border-b pb-2">The Medical Science Behind Acupuncture Honolulu</h2>
              <p className="text-lg text-slate-700 leading-relaxed mb-6">
                When patients seek specialized care for acupuncture honolulu, they immediately experience the difference that decades of clinical expertise make. Acupuncture works by stimulating specific strategic points on the body, which significantly increases peripheral blood flow, acts as a natural anti-inflammatory, and effectively down-regulates pain receptors in the brain. 
              </p>
