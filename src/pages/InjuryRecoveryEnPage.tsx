                ...
                <div className="md:w-1/2 w-full max-w-md bg-slate-800 rounded-3xl p-10 shadow-2xl border border-slate-700 ring-4 ring-blue-900/30">
                    {isSuccess ? (
                        <div className="text-center py-10 animate-in zoom-in duration-500">
                            ...
                            <p className="text-slate-400 mb-8">Our medical staff will call you to verify your insurance and secure your appointment.</p>
                        ...
                        <form onSubmit={submitForm} className="space-y-5">
                            ...
                            <p className="text-slate-400 mb-8 text-sm">Don't wait for the pain to become chronic. Fill out the form to get started.</p>
