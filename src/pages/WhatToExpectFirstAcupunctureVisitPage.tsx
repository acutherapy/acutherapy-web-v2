...
export default function WhatToExpectFirstAcupunctureVisitPage() {
  return (
    <>
      <Helmet>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-12 gap-12">
          ...
          <article className="md:col-span-8">
            ...
            <div className="text-[16px] md:text-[18px] text-slate-700 leading-[1.8] mb-10 space-y-4">
              <p>If treatment is appropriate, an <Link to="/acupuncture-honolulu" className="text-blue-600 hover:underline">acupuncture session</Link> may be performed during the first visit.</p>
              ...
              <p>The needles used are extremely thin—very different from those used for injections. <strong className="text-slate-900">Acupuncture needles are sterile, single-use, and regulated for safety in the United States.</strong></p>
            ...
            <div className="text-[16px] md:text-[18px] text-slate-700 leading-[1.8] mb-10 space-y-4">
              <p>Most <Link to="/what-to-expect-first-acupuncture-visit" className="text-blue-600 hover:underline">first visits</Link> in Honolulu take longer than follow-up sessions.</p>
              <div className="bg-blue-50 border-l-4 border-blue-600 p-6 my-6 rounded-r-xl">
                 <p className="text-[16px] md:text-[18px] text-slate-800 font-medium italic">
                   "During a first acupuncture visit, patients typically undergo a detailed consultation followed by a treatment session lasting about 20–30 minutes."
                 </p>
              </div>
              ...
              <ul className="list-disc pl-6 space-y-2 mb-4 bg-emerald-50/50 p-6 rounded-xl border border-emerald-100">
                ...
                <li>Time for both consultation and <Link to="/acupuncture-honolulu" className="text-blue-600 hover:underline">treatment session</Link></li>
              </ul>
              <p>This allows for a more thorough and personalized approach, ensuring conditions like <Link to="/neck-pain-treatment-honolulu" className="text-blue-600 hover:underline">neck pain</Link> or <Link to="/back-pain-acupuncture-honolulu" className="text-blue-600 hover:underline">back pain</Link> are properly mapped out.</p>
            </div>
