  ...
  return (
    <>
      ...
      <div className="relative rounded-3xl overflow-hidden shadow-2xl ring-4 ring-white/50 group mb-12 w-full max-w-3xl mx-auto">
        <img loading="lazy" src="/images/abdominal-acupuncture.jpg" alt="Acupuncture Moiliili" className="w-full h-[450px] object-cover transition-transform duration-700 group-hover:scale-105" onError={(e) => { e.currentTarget.src = 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=800'; }} />
...
<h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6 border-b pb-2">What Causes Moiliili?</h2>
<p className="text-lg text-slate-700 leading-relaxed mb-6">Moiliili Students, faculty, and long-time residents in the Moiliili area frequently experience tech neck from studying, or age-related osteoarthritis from years of hard work.</p>
...
<div><h4 className="font-bold text-lg text-slate-900">Q1: How convenient is it to visit from Moiliili?</h4><p className="text-slate-700">A: Beyond pain relief, acupuncture strongly regulates the nervous system, drastically lowering cortisol and relieving the physical manifestations of stress common in demanding academic or professional lives.</p></div>
