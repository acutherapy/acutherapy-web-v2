...
export default function SciaticaAcupunctureHonoluluPage() {
  return (
    <>
      <Helmet>
        ...
        <script type="application/ld+json">
          {`
          {
            ...
            "@type": "MedicalWebPage",
            "name": "Sciatica Acupuncture Honolulu Treatment in Honolulu | AcuTherapy Clinics",
            "headline": "Sciatica Acupuncture Honolulu",
            "description": "Tired of Sciatica Acupuncture Honolulu? Dr. David Cai provides effective, non-surgical relief using advanced acupuncture and traditional Chinese medicine in Honolulu.",
            "url": "https://acutherapy.com/sciatica-acupuncture-honolulu",
            "provider": {
