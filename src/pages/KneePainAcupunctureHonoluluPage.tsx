  ...
  return (
    <>
      <Helmet>
        ...
        <script type="application/ld+json">
          {`
          {
            ...
            "@type": "MedicalWebPage",
            "name": "Knee Pain Acupuncture Honolulu Treatment in Honolulu | AcuTherapy Clinics",
            "headline": "Knee Pain Acupuncture Honolulu",
            "description": "Tired of Knee Pain Acupuncture Honolulu? Dr. David Cai provides effective, non-surgical relief using advanced acupuncture and traditional Chinese medicine in Honolulu.",
            "url": "https://acutherapy.com/knee-pain-acupuncture-honolulu",
            "provider": {
      ...
      <div className="relative rounded-3xl overflow-hidden shadow-2xl ring-4 ring-white/50 group mb-12 w-full max-w-3xl mx-auto">
        <img src="/images/abdominal-acupuncture.jpg" alt="Knee Pain Acupuncture Honolulu" className="w-full h-[450px] object-cover transition-transform duration-700 group-hover:scale-105" onError={(e) => { e.currentTarget.src = 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=800'; }} />
