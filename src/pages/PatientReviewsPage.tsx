...
export default function PatientReviewsPage() {
  return (
    <>
      <Helmet>
        <title>Patient Reviews | Honolulu Acupuncture Guide</title>
        <meta name="description" content="Learn more about Patient Reviews. Dr. David Cai from AcuTherapy Clinics answers your questions about acupuncture efficacy and treatment processes." />
        <script type="application/ld+json">
          {`
          {
            "@context": "https://schema.org",
            "@type": "MedicalWebPage",
            "name": "Patient Reviews | Honolulu Acupuncture Guide",
            "headline": "Patient Reviews",
            "description": "Learn more about Patient Reviews. Dr. David Cai from AcuTherapy Clinics answers your questions about acupuncture efficacy and treatment processes.",
            "url": "https://acutherapy.com/patient-reviews",
            "provider": {
      ...
      <section className="bg-blue-900 text-white relative py-20 lg:py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 tracking-tight">Patient Reviews</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-12 gap-12">
          ...
          <article className="md:col-span-8">
            ...
            <p className="text-xl text-slate-800 leading-relaxed font-medium mb-8">
              At AcuTherapy Clinics, we take pride in the results we deliver. Read what our past patients have to say about their healing and recovery journeys with Dr. David Cai here in Honolulu.
            </p>

            <div className="relative rounded-3xl overflow-hidden shadow-2xl ring-4 ring-white/50 group mb-12 w-full max-w-3xl mx-auto">
              <img src="/images/abdominal-acupuncture.jpg" alt="Patient Reviews" className="w-full h-[450px] object-cover transition-transform duration-700 group-hover:scale-105" onError={(e) => { e.currentTarget.src = 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=800'; }} />
              <figcaption className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-blue-900/90 to-transparent p-8 pt-16 text-white text-lg font-medium">Trusted Honolulu Holistic Care</figcaption>
            </div>

            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-8 border-b pb-2">Real Patient Reviews</h2>
