...
def insert_after_regex(filepath, regex_str, html):
    ...
    if match:
        ...
        print(f"Failed to find {regex_str} in {filepath}")
...
"""
insert_after_regex("src/pages/AcupunctureSafetyPage.tsx", r'Understanding Acupuncture Safety<.*?/h2>', safety_text)
...
"""
insert_after_regex("src/pages/AcupunctureVsChiropracticBackPainPage.tsx", r'Not Sure Which Option Is Right for You\?<.*?/h2>', choiceText)
